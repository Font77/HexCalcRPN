...
class HexStackUnitTest64Bit {
    ...
    fun collectionConstructor_isCorrect() {
        ...
        assertEquals(0xBADFFFFFFFF, hs.pop().toLong())
    ...
    fun addition_isCorrect() {
        ...
        stack.add()
        assertEquals(1, stack.size)
        assertEquals(0x1_0000_0000, stack.pop().toLong())
        stack.push(BIG_INT_MAX_64)
        stack.push(1)
        stack.add()
        assertEquals(1, stack.size)
        assertEquals(0, stack.pop().toLong())
        stack.push(53)
        stack.push(BIG_INT_MAX_64.minus(BigInteger.valueOf(27)))  // 2's comp of 28
        stack.add()
        assertEquals(1, stack.size)
        assertEquals(25L, stack.pop().toLong())
    }
    ...
    fun multiply_isCorrect() {
        ...
        stack.multiply()
        assertEquals(1, stack.size)
        assertEquals(0xBA_D041_3111, stack.pop().toLong())
        ...
        assertEquals(1, stack.size)
        assertEquals(0x41_3111, stack.pop().toInt())
    }
    ...
    fun divide_isCorrect() {
        ...
        stack.divide()
        assertEquals(1, stack.size)
        assertEquals(0xBA_E75C_309E, stack.pop().toLong())
    }
    ...
    fun mod_isCorrect() {
        ...
        stack.mod()
        assertEquals(BigInteger.valueOf(0x26A3_0A44), stack.pop())
    }
